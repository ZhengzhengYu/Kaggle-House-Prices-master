...
train_df_munged.to_csv('train_human_analog.csv', index=False)
test_df_munged.to_csv('test_human_analog.csv', index=False)
label_df.to_csv('output_human_analog.csv', index=False)
